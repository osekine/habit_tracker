...
mixin _$Habit {
 ...
 int get id; String get name; String? get description; String get colorName; List<DailyProgress> get days; bool get isActive; Category? get category;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,colorName,const DeepCollectionEquality().hash(days),isActive,category);

@override
String toString() {
  return 'Habit(id: $id, name: $name, description: $description, colorName: $colorName, days: $days, isActive: $isActive, category: $category)';
}
...
@useResult
$Res call({
 int id, String name, String? description, String colorName, List<DailyProgress> days, bool isActive, Category? category
});
...
/// Create a copy of Habit
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? description = freezed,Object? colorName = null,Object? days = null,Object? isActive = null,Object? category = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  String? description,  String colorName,  List<DailyProgress> days,  bool isActive,  Category? category)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Habit() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.colorName,_that.days,_that.isActive,_that.category);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  String? description,  String colorName,  List<DailyProgress> days,  bool isActive,  Category? category)  $default,) {final _that = this;
switch (_that) {
case _Habit():
return $default(_that.id,_that.name,_that.description,_that.colorName,_that.days,_that.isActive,_that.category);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  String? description,  String colorName,  List<DailyProgress> days,  bool isActive,  Category? category)?  $default,) {final _that = this;
switch (_that) {
case _Habit() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.colorName,_that.days,_that.isActive,_that.category);case _:
  return null;
...
class _Habit implements Habit {
  const _Habit({required this.id, required this.name, required this.description, required this.colorName, required final  List<DailyProgress> days, required this.isActive, this.category}): _days = days;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,colorName,const DeepCollectionEquality().hash(_days),isActive,category);
...
/// Create a copy of Habit
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? description = freezed,Object? colorName = null,Object? days = null,Object? isActive = null,Object? category = freezed,}) {
  return _then(_Habit(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,description: freezed == description ? _self.description : description // ignore: cast_nullable_to_non_nullable
